...
session_start();
$query="SELECT * FROM tb_receipt WHERE User_ID='".$_SESSION['User_ID']."'";
if ($sql=mysqli_query($conn,$query)){
	$total_query="SELECT sum(`Total Price`) FROM tb_receipt WHERE User_ID='".$_SESSION['User_ID']."'";
...
<?php }?>
	<tr>
		...
		<td><?php echo $total['sum(`Total Price`)'];?></td>
	</tr>
	</tbody>
	</table>

		<button type="button" onclick="window.location.href='.php'">Pay</button>
</div>
</form>
<script>
